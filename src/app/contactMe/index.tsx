...
const ContactMePage = () => {
  ...
  return (
    <div className="h-full pb-10 px-4">
      <div>
        <p className="font-bold text-2xl max-sm:text-xl">CONTACT ME</p>
      </div>
        ...
        <div className="w-5/12 max-sm:w-full">
          <form action="" onSubmit={handleSubmit}>
            <div className="sm:col-span-4">
              ...
              <div className="mt-2">
                <div className="flex rounded-sm shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 border">
                  <input
                    type="text"
                    name="username"
                    id="username"
                    className="block flex-1 border-0 bg-transparent h-11 py-1.5 pl-3 text-gray-900 dark:text-white placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6 sm:max-w-md"
            ...
            <div className="sm:col-span-4  mt-4">
              ...
              <div className="mt-2">
                <div className="flex rounded-sm shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                  <input
                    type="text"
                    name="username"
                    id="username"
            ...
            <div className="col-span-full  mt-4">
              ...
              <div className="mt-2">
                <textarea
                  id="about"
                  name="about"
                  className="block w-full rounded-sm border-0 p-3 text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                  onChange={(e) =>
            ...
            <div className="mt-6 flex items-center justify-start gap-x-6">
              <button
                type="submit"
                className="rounded-sm bg-theme-color-200 px-6 py-2 text-sm font-semibold text-white shadow-sm hover:bg-theme-color-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Submit
              </button>
